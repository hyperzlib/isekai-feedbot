...
export class InternalLLMFunction {
    ...
    public async initialize() {
        this.mainController.registerLLMFunction('get_date_time', {
            displayName: '获取当前时间',
        ...
        this.mainController.registerLLMFunction('search_on_web', {
            displayName: '在线搜索',
        ...
        this.mainController.registerLLMFunction('recognize_image', {
            displayName: '识别图片',
